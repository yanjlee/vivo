...
git clone https://github.com/vivopay/vivo
```
...
```bash
    ...
    From https://github.com/vivopay/vivo
...
[vivo/gitian.sigs](https://github.com/vivopay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
